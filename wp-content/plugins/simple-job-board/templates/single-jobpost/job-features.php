...
<div class="job-features">
    ...
    if ( 0 < $keys || NULL != $job_category ):
        ?>
        <h3><?php echo apply_filters('sjb_job_features_title', esc_html__('Đặc điểm công việc', 'simple-job-board')); ?></h3>
        <?php
    endif;
    ?>
    ...
    <table class="table">
        <tbody>
            ...
            if (sjb_get_the_job_category()):
                echo '<tr><td>' . esc_html__('Ngành nghề', 'simple-job-board') . '</td><td>';
